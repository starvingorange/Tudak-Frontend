...
const variantClasses = {
  ...
  primary:
    "bg-[var(--brand-yellow)] text-[var(--brand-on-yellow)] text-[15px] px-6 py-3 rounded-[var(--radius-button)] hover:brightness-105",
  outline:
...
export function Button({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "inline-flex items-center gap-[9px] font-sans font-extrabold no-underline transition-colors box-border",
